(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var newArray = _.filter(collection, function(value){
        return !test(value);
    });
    return newArray;
  ...
  _.uniq = function(array) {
    ...
    for(var i = 0 ; i < array.length ; i ++){
      ...
      for(var j = 0 ; j < newArray.length ; j ++){
          if(newArray[j]===search) test = false;
      }
  ...
  _.every = function(collection, iterator) {
     ...
     return _.reduce(collection, function(wasNotFound, item){
        if(wasNotFound === true) return true;
        if(iterator(item)===false) return false;
        return true;
     });//function(wasFound, item){
    return true;
    //     var resp = iterator(total,item );
    //     if(wasFound){
    //       return false;
    //     } 
    //       return 
